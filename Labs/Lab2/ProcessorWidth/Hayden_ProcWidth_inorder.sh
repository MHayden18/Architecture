...
echo "done"
echo "running diff on compress95 in-order width 2, intalu 2, intmult 1, memprt 1"
...
echo "done"
echo "running diff on compress95 in-order width 4, intalu 3, intmult 2, memprt 2"
...
sim-outorder -fetch:ifqsize 8 -decode:width 8 -issue:width 8 -commit:width 8 -res:ialu 6 -res:imult 3 -res:memport 2 -issue:inorder true -redir:sim "compress95_stdout_8_6_3_2_inorder.txt" compress95.ss < compress95.in > compress95_output_8_6_3_2_inorder.txt 
echo "done"
echo "running diff on compress95 in-order width 8, intalu 6, intmult 3, memprt 2"
