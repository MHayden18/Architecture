...
-redir:sim "Baseline_Taken_Inorder.txt" cc1.ss -O 1stmt.i 
echo "done"
...
-redir:sim "Baseline_NotTaken_InOrder.txt" cc1.ss -O 1stmt.i 
echo "done"
...
-redir:sim "Baseline_2Lev_InOrder.txt" cc1.ss -O 1stmt.i 
echo "done"
